...
CREATE TABLE `Amenities` (
  ...
  CONSTRAINT `Amenities_ibfk_1` FOREIGN KEY (`HotelRoomID`) REFERENCES `HotelRoom` (`HotelRoomID`) ON DELETE CASCADE ON UPDATE CASCADE
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger chkstreet2
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger chkstreet
...
INSERT INTO `History` VALUES (1,123213,12,'1972-01-01 00:00:01','1973-01-01 00:00:01',0),(2,123213,129,'1972-01-01 00:00:01','1973-01-01 00:00:01',0);
...
INSERT INTO `Hotel` VALUES (1,2,5,1,'Papastratou','10','17237','Athens'),(2,3,5,1,'Imittou','3','41231','Athens'),(3,4,5,1,'Kanari','100','31298','Kolokotronitsi'),(4,5,5,1,'Adsad','213','32133','Thesalloniki'),(5,1,9,1,'Adsaokdp','312','39081','Patras'),(6,1,5,2,'Adasdsa','321','32132','RickAndMorty'),(7,3,5,2,'Mpotsari','21','31212','Bolzano'),(8,3,5,2,'Adsadasd','23','33213','Weierstrass'),(9,4,5,2,'ASdsadsa','234','32121','Bolzano'),(10,5,5,2,'Adsadsad','342','43242','Einstein'),(11,1,5,3,'Ilioupolis','12','16263','Athens'),(12,2,5,3,'Argiroupolis','44','13515','Volos'),(13,3,5,3,'Iliou','123','41244','Volos'),(14,4,5,3,'Os','125','12421','Bolzano'),(15,5,5,3,'Damni','31','51255','Einstein'),(16,1,5,4,'Traino','124','21412','Rassias'),(17,2,5,4,'Tikano','51','31233','Cuppertino'),(18,3,5,4,'Popis','241','12412','Rassias'),(19,4,5,4,'Fuuuu','25','12415','RickAndMorty'),(20,5,5,4,'Toutou','124','12424','Popos'),(21,1,1,5,'ASdsadas','345','32423','Weierstrass'),(22,2,2,5,'Adasdsadas','432','32131','California'),(23,3,3,5,'Adasidla','423','87989','Palo Alto Arkadias'),(24,4,5,5,'Adsadasa','321','23123','Cuppertino'),(25,5,4,5,'Elm Street','321','32312','California'),(36,5,5,1,'Test Street','34','43234','California'),(37,1,0,5,'A street','3','12341','California'),(38,2,1,5,'The street','12','12341','California');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger chknrrooms
before insert on Hotel
for each row
begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger chkstreet3
before insert on Hotel
for each row
begin
IF (new.StreetNumber < 0) THEN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger chkstars
before insert on Hotel
for each row
begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger chknrhotels
...
INSERT INTO `HotelGroupPhoneNumbers` VALUES (1,1,'1604042397'),(2,2,'1827094517'),(3,3,'1802094588'),(4,4,'1576973590'),(5,5,'1334325946'),(17,1,'6979614463'),(18,5,'6979614463'),(19,5,'6979614463'),(20,5,'2107626351');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger phonecheck before insert on HotelGroupPhoneNumbers
for each row
begin 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger phonecheck2 before insert on HotelPhoneNumbers
for each row
begin 
IF (new.PhoneNumber regexp '^(\\+?[0-9]{1,4}-)?[0-9]{3,10}$' ) = 0 THEN 
  SIGNAL SQLSTATE '45000'
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger chkprice
before insert on HotelRoom
for each row
begin
IF (new.Price < 0) THEN
...
INSERT INTO `Rents` VALUES (1,123214,6772345,12,'2020-10-02 12:01:00','2021-10-02 11:59:00',199,'CREDIT'),(2,3,6772345,12,'2020-10-02 12:01:00','2021-10-02 11:59:00',NULL,NULL),(4,3,6772345,1,'1970-01-01 00:00:01','1971-01-01 00:00:01',11,'CREDIT');
...
INSERT INTO `Reserves` VALUES (1,3,1,'1970-01-01 00:00:01','1971-01-01 00:00:01',1),(3,123214,12,'2020-10-02 12:01:00','2021-10-02 11:59:00',0),(4,123214,12,'2100-02-01 12:01:00','2101-02-01 11:59:00',0),(5,123213,12,'2200-02-02 12:01:00','2201-02-02 11:59:00',0),(6,123213,1,'2200-02-02 12:01:00','2201-02-02 11:59:00',0),(7,123213,121,'2200-02-02 12:01:00','2201-02-02 11:59:00',0),(8,123213,121,'2210-02-02 12:01:00','2211-02-02 11:59:00',1),(9,123213,12,'1970-01-01 00:00:01','1971-01-01 00:00:01',1),(10,123213,12,'1972-01-01 00:00:01','1973-01-01 00:00:01',0);
